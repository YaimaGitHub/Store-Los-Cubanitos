...
@media only screen and (max-width: 300px) {
  .prev, .next,.text {font-size: 11px}
   ...
   <div class="footer-icons">
    ...
    <img src="play.jpg" style="
    height: 50px;"><br>
    <br>
    <img src="play1.jpg" style="
    height: 47px;">
    </div>
    ...
    font-size:larger;
    background-repeat:no-repeat;">  
    <img src="whatsapp.png" style="height: 30px;margin-bottom: 0px;margin-left: 0px;"><span style="">Whatsapp</span></a>
    <a data-toggle="tooltip" data-placement="top" title="" href="tel:9758695632 " style="
    color:black ;
    width: 60%;
    font-size:smaller;
    "><img src="phone.png" style="
    height: 30px;">
    <span>Call Us</span></a>              
    </div>
    </div>
