...
<%
   ArrayList<Electrical> electricalList  = (ArrayList<Electrical>)request.getAttribute("ELECTRICALLIST");
   Iterator itr = electricalList.iterator();
   while(itr.hasNext())
   {  
        Electrical ee =(Electrical)itr.next();
%>   
              
    <br>

<div class ="electricbox">
    <img src="<%=request.getContextPath()%>/DownloadImage?electricalPID=<%=ee.getProductId()%>"   max-width="250px" height="200px">
