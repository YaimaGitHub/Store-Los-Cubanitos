...
.dark-mode {
  ...
  color: white;
	...
	<body>
        ...
        <a href="customerlog.jsp"><i class="fa fa-fw fa-user"></i> Login/Signup</a>		
      </form>
    </div>
	<script>
function myFunction() {
...
<div class="slideshow-container">
          ...
          <div class="mySlides fade">
            <div class="numbertext"></div>
            <img src="images/b.png" style="width:100%;height: 280px;">
            <div class="text"></div>
          </div>
	...
	<form >
		...
		<div class="container">
			<div class="product1">
				<img src="images/washingmac.png">
					<div class="desc">Bosch 6 kg Fully-Automatic<br> Front Loading Washing Machine</div><br>
					<div class="price"> Rs.20,499.00</div>
					<a href="customerlog.jsp"><div class="btn">VIEW</div></a>
			</div>
            <div class="product2">
				<img src="images/led.png">
					<div class="desc">Samsung 80 cm (32 inches) Wondertainment Series<br> HD Ready LED Smart TV UA32TE40AAKXXL<br> (Titan Gray) (2020 Model)</div>
					<div class="price">Rs. 14,999.00</div>
					<a href="customerlog.jsp"><div class="btn">VIEW</div></a>
			</div>
		
            <div class="product3">
				<img src="images/portspeaker.png">
					<div class="desc">Infinity (JBL) Fuze 100 Deep Bass Dual<br> Equalizer IPX7 Waterproof Portable<br> Wireless Speaker (Charcoal Black)</div>
