...
<div class="bg-image"></div>
   ...
   <div class="box">     
  <form class="box" name="Signupform" action="signsubmit.jsp" method="post">
    <h1 style="color: black">Signup</h1>
       <input type="text" name="cname" placeholder="Customer name" required>
       <input type="Date" name="Dob" placeholder="date of birth" required>
       <input type="Integer" name="Phone" placeholder="Phone_number" required>
       ...
       <!-- <input type="password" name="passw" placeholder="Re-enter Password" required> -->
       <input  type="submit" name="submit" onclick="#)" >
       <p class="log" style="color: black">Existing user? <a href="customerlog.jsp">Click here</a>
