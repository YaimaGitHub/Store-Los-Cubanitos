...
public class UploadElectronicsServlet extends HttpServlet
{
            ...
            try
            {
             ...
             //String product_image=request.getParameter("pimage");
                    ...
                    if (filePart != null) {
                     ...
                     q="insert into electronics (name_of_the_shop,address,product_type,product_name,product_image,product_id,cost_of_the_product,view_more_info,image_content_type) values (?,?,?,?,?,?,?,?,?)";
