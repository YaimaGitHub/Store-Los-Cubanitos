...
public class DownloadElectronicsImageServlet extends HttpServlet
{
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        String pid = req.getParameter("electronicsPID");
        ...
        //  setProductCost  setImgdata			
                     q="select product_image,image_content_type from electronics where product_id=? ";
